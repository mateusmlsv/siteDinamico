				...
				<tbody>
					@foreach($usuario->papeis as $papel)
						<tr>							
							...
							<td>								
								<a class="btn red" href="javascript: if(confirm('Remover esse papel?')){ window.location.href = '{{route('admin.usuarios.papel.remover',[$usuario->id,$papel->id])}}' }"><i class="material-icons">remove_circle</i></a>
							</td>
						</tr>
					@endforeach
				</tbody>
