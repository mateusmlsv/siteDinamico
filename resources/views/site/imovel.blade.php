    ...
    <div class="row section">
    	<div class="col s12 m8">
            ...
            <div class="row" align="center">
                <button onclick="sliderPrev()" class="btn blue"><i class="large material-icons">
arrow_back</i></button>
                <button onclick="sliderNext()" class="btn blue"><i class="large material-icons">
arrow_forward</i></button>
            </div>
            @else
